        ...
        <div className="dark:bg-black">
            ...
            <div className="lg:flex py-24 max-md:py-14">
                ...
                <div className="flex flex-col items-center justify-center lg:w-1/3 pt-6">
                    ...
                    <div className="text-lg max-md:text-xs text-center px-3 pt-2 font-medium  dark:text-white" >AI will generate topics and subtopics based on the topic you provide</div>
                </div>
