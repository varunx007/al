//BRAND
export const name = 'a2zlearn';
export const company = 'a2zlearn';
export const websiteURL = 'https://al-green.vercel.app/';
...
export const from = "Dr. Emily Roberts";
export const profession = 'Student';
export const photoURL = 'https://media.istockphoto.com/id/1369754239/photo/university-student-in-white-background-stock-photo.jpg?s=612x612&w=0&k=20&c=LjFVDfjusWBjYTNliHV9DyXfApPGc8DmgBGEtfVgQ0Q=';
